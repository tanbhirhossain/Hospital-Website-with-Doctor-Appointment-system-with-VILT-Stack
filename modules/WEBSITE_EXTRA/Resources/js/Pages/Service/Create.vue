...
const handleImage = (field: 'thumbnail' | 'banner', e: Event) => {
    ...
    if (f) {
        form[field] = f;
        if (field === 'thumbnail') imagePreview.value = URL.createObjectURL(f);
        if (field === 'banner') bannerPreview.value = URL.createObjectURL(f);
    }
};
                    ...
                    >
                        <div class="mb-4 flex items-center gap-2">
                            ...
                            <span class="ml-auto text-xs text-gray-400"
                                >{{ galleryPreviews.length }} image(s)</span
                            >
                        </div>
                        <p class="mb-3 text-xs text-gray-500">
                            Upload multiple images to showcase this service. Supported: JPG, PNG,
                            WEBP (max 4 MB each).
                        </p>
                ...
                <div class="space-y-4">
                    ...
                    >
                        ...
                        >
                            <img
                                v-if="imagePreview"
                                :src="imagePreview"
                                class="mx-auto mb-2 max-h-32 rounded object-cover"
                            />
                    ...
                    >
                        ...
                        <p class="mt-1 text-[10px] text-gray-400">
                            Banner shown on the service detail page header.
                        </p>
                    </div>

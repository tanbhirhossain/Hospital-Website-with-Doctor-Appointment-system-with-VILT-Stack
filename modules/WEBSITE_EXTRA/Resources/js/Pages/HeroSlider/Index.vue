...
const editSlider = (s: Slider) => {
    ...
    form.buttons = s.buttons;
    form.gradients = s.gradients;
    form.clearErrors();
};
                    ...
                    <div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-900">
                        ...
                        <form @submit.prevent="submit" class="space-y-4 p-5">
                            ...
                            <div>
                                ...
                                <textarea v-model="form.buttons" rows="3" placeholder="json button..." class="mt-1 w-full rounded-md border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-violet-400 focus:ring-2 focus:ring-violet-200 dark:border-gray-600 dark:bg-gray-800 dark:text-white"></textarea>
                            </div>
                            <div class="grid grid-cols-2 gap-3">
                                <!-- <div>
                                    <Label>Buttons (JSON)</Label>
                                    <Input v-model="form.buttons" placeholder="JSON format" class="mt-1" />
                                </div> -->
                                <div>
                                    <Label>Gradients</Label>
                                    <Input v-model="form.gradients" placeholder="" class="mt-1" />
                                </div>
                            </div>
                            <div class="grid grid-cols-2 gap-3">
                                <div>
